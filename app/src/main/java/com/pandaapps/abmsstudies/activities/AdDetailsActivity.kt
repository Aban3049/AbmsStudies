...
import com.pandaapps.abmsstudies.adapters.AdapterImageSlider
import com.pandaapps.abmsstudies.databinding.ActivityAdDetailsBinding
import com.pandaapps.abmsstudies.models.ModelAd
import com.pandaapps.abmsstudies.models.ModelImageSlider
    ...
    private fun deleteAd() {
        ...
        ref.child(adId)
            ...
            .addOnFailureListener { e ->
                ...
                Utils.toast(this@AdDetailsActivity, "Failed to delete due to ${e.message}")
            }
    }
}